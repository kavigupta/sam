"""
Adapted from https://github.com/pytorch/pytorch/tree/8fa328f88e12d55a216e3274a013767a6a7626f6

Multiheadattention with the one modification being not taking the mean of the attention matrices
"""
...
def multi_head_attention_forward(
    ...
    if attn_mask is not None:
        ...
        if attn_mask.dtype == torch.uint8:
            warnings.warn(
                "Byte tensor for attn_mask in nn.CustomMultiheadAttention is deprecated. Use bool tensor instead."
            )
    ...
    if key_padding_mask is not None and key_padding_mask.dtype == torch.uint8:
        warnings.warn(
            "Byte tensor for key_padding_mask in nn.CustomMultiheadAttention is deprecated. Use bool tensor instead."
        )

...
change_adaptive_sparsity_speed_for_gtex(msp, tissue_groups)

msp.architecture.update(
    type="MultiTissueProbabilitiesPredictorMultiAggregator",
    num_tissues=len(tissue_groups),
)

msp.acc_thresh = 0
msp.extra_params += " --learned-motif-sparsity-threshold-initial 75"

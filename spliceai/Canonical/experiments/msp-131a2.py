...
msp.file = __file__
msp.seed = int(argv[1])
msp.architecture["num_motifs"] = 58
...
msp.architecture["motif_model_spec"] = dict(
    ...
    model_to_adjust_spec=dict(
        ...
        exclude_names=("3P", "5P") + tuple(['UNK', 'RBM23', 'PUM1', 'FUBP3', 'PCBP4', 'MBNL1', 'RBMS2', 'EWSR1', 'CPEB1', 'HNRNPC', 'PUF60', 'KHDRBS3', 'SNRPA', 'RBFOX2', 'RBM22', 'PCBP1'] + ['SRSF4', 'SRSF10', 'PCBP2', 'DAZ3', 'HNRNPH2', 'PRR3', 'PABPN1L', 'SF1']),
    ),

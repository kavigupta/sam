...
msp.architecture["propagate_sparsity_spec"] = dict(type="OnlyAllowInfluenceOnSplicesites")
...
msp.architecture["influence_calculator_spec"]["post_sparse_spec"] = dict(type="Linear")
